...
void sx1278_init(void)
{
	...
	sprintf(version, "lora version: %d \n", ver);
   HAL_UART_Transmit(&huart2, (uint8_t*)version, 20, 1000);
	sx1278_sleep();
 ...
 */
bool sx1278_listen_to_talk(void)
{
  sx1278_standby();
...
void sx1278_DIO_handle(void)
{
    is_LoRa_EXTI = true;
}

bool Is_LoRa_EXTI(void)
{
    return is_LoRa_EXTI;
}
